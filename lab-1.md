...
Имеет идентификатор клиента, совершившего заказ; идентификатор сотрудника, работающего над заказом; идентификатор модели автомобиля; цена модели на момент заказа.
...
Имеет идентификатор клиента, совершившего заказ; идентификатор сотрудника, работающего над заказом; идентификатор модели автомобиля; идентификаторы кузова, двигателя, кпп, руля, интерьера, колёс; цена модели на момент заказа.
